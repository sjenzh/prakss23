...
cur.execute("INSERT INTO messages (received_date, subject, sender, content, has_attachment) VALUES (?, ?, ?, ?, ?)", (datetime.datetime.now().isoformat(), 'Subject of message 1', 'thisisanemail@email.com', 'content of message 1', 1))
